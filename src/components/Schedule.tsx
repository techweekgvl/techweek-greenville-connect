...
const days: DayData[] = [
  ...
  },
  {
    ...
    events: [{
      ...
      description: "Tuesday's plans have changed — our City Club event won't be going ahead, and we're sorry for the switch. In its place, Business Building 101 runs as one continuous conversation with no breakout sessions: Nick Dennis opens with Robert Lee, then Bryan Davis and Lawson Pope take the floor. An honest look at what building a business actually takes — powerful insights, straight answers, and advice you can act on the next morning. More details to come.",
      lineup: [
        { role: "Opening Conversation", name: "Nicholas Dennis", title: "Founder, Tech Week Greenville" },
        { role: "Opening Conversation", name: "Robert Lee", title: "Financial Consultant, The Cash Compound" },
        { role: "Followed By", name: "Bryan Davis", title: "Executive Director, The Hill Institute — Furman University" },
        { role: "Followed By", name: "Lawson Pope", title: "Founder, Enduragum" },
      ],
    ...
    events: [
      {
        ...
        lineup: [
          { role: "Moderator", name: "Erine Kabous" },
          { role: "Featured Guest", name: "Jason Lavoie", title: "Owner, Internet Solutions Co." },
        ],
